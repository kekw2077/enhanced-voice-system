...
const Map<String, Map<String, String>> _i18n = {
  'ru': {
    ...
    'navVoiceInput': 'Микрофон и распознавание',
    'navVoiceInputSub': 'что и как слышит ассистент',
    ...
    'navLog': 'Журнал',
    'navLogSub': 'что происходило в приложении',
    ...
    'startupView': 'После запуска показывать',
    'startupViewDesc': 'Окно программы и плавающий виджет выбираются вместе. Готовность слушать ассистент озвучивает в любом случае — даже если на экране нет ничего.',
    'startupViewWidget': 'Только виджет',
    'startupViewBoth': 'Окно и виджет',
    'startupViewWindow': 'Только окно',
    'startupViewNone': 'Ничего',
    ...
    'sttEngineDesc': 'Движок EVS (Whisper/GigaAM локально либо распознавание на сервере)',
    'localEngineName': 'Локальный (EVS)',
    'msShort': 'мс',
    'cardSttModel': 'Движок распознавания',
    ...
    'engRemoteName': 'На сервере',
    'engRemoteShort': 'Распознаёт чужая видеокарта. Нужен свой сервер',
    'engRemoteDetail':
        'Фраза уходит на сервер по адресу ниже (контракт OpenAI: POST /v1/audio/transcriptions). Микрофон, шумоподавление и нарезка фраз остаются здесь — на сервер уезжает уже готовая фраза, а не поток. Подходит любой готовый OpenAI-совместимый сервер: speaches, whisper.cpp server, vLLM. Если сервер не отвечает, фразу подхватывает локальный Whisper, и об этом будет сказано.',
    'engRemoteUrl': 'Адрес сервера',
    'engRemoteModel': 'Модель',
    'engRemoteKey': 'Ключ доступа (если нужен)',
    'engRemoteCheck': 'Проверить',
    'engRemoteOnline': 'Сервер отвечает',
    'engRemoteOffline': 'Сервер не отвечает',
    'engRemoteNoUrl': 'Сначала укажите адрес сервера',
    ...
    'nxCloseHint': 'закрыть —',
    'clonePhr2Title': 'Заготовленные фразы',
    'clonePhr2Hint': 'Эти фразы заранее озвучены вашим клон-голосом и играют мгновенно, не нагружая видеокарту (в том числе при выключенном клон-сервере). Всего: {n}.',
    ...
    'chatTurnedOff': 'Чат выключен',
    'sysChatOn': 'Включить чат',
    'sysChatOff': 'Выключить чат',
    'navAssistantVoice': 'Голос ассистента',
    'navAssistantVoiceSub': 'озвучка, эффекты, клон',
    // Второй уровень навигации настроек: подразделы внутри раздела.
    'pgBasics': 'Основные',
    'pgStartup': 'Запуск и трей',
    'pgMicDevice': 'Устройство',
    'pgStt': 'Распознавание',
    'pgListen': 'Прослушивание',
    'pgVoiceOut': 'Озвучка',
    'pgVoiceEngine': 'Движок синтеза',
    'pgVoiceClone': 'Клон и нагрузка GPU',
    'pgVoiceFx': 'Эффекты голоса',
    'pgVoicePhrases': 'Заготовленные фразы',
    'pgWsLook': 'Вид',
    'pgWsParams': 'Параметры',
    'pgCmdExec': 'Выполнение',
    'pgCmdCatalog': 'Каталог команд',
    'pgCmdSecurity': 'Безопасность',
    'pgLlmConn': 'Подключение',
    'pgLlmModels': 'Модели',
    'pgLlmParams': 'Параметры генерации',
    'pgPersonaStyle': 'Стиль общения',
    'pgPersonaMemory': 'Память',
    'pgPrivAccess': 'Доступ и ограничения',
    'pgPrivData': 'Данные',
    'pgAboutInfo': 'Версия и обновления',
    'pgChangelog': 'История изменений',
    'settingsSearchHint': 'Поиск по настройкам…',
    'voiceStatusMic': 'Микрофон',
    'voiceStatusStt': 'Распознавание',
    'voiceStatusVoice': 'Голос',
    'voiceStatusReady': 'слушает',
    'voiceStatusPtt': 'по удержанию клавиши',
    'pttHintHold': 'Зажмите и говорите',
    'pttHintUnset': 'Назначьте клавиши удержания в настройках',
    ...
    'micGainDesc':
        'Насколько громче делать сигнал микрофона. Помогает, если вас плохо '
            'слышно или вы сидите далеко: тихая речь иначе не проходит порог '
            'громкости, каким бы чувствительным ни был детектор речи. Усиливает '
            'и шум — поднимайте только до нужного. 1.0x — без изменений.',
    'micSensLow': 'Низкая',
    'micSensMed': 'Средняя',
    'micSensHigh': 'Высокая',
    'micSensMax': 'Максимум',
    'ttsFx': 'Эффект голоса (FX)',
    'ttsFxDesc': 'Пост-обработка синтеза/клона: расстройка-дубль, металлик, реверб, срез верхов — например «синтетический ИИ» в духе EDI.',
    'ttsFxPreset': 'Пресет',
    'ttsFxPresetDesc': 'Применить готовую настройку (EDI).',
    'ttsFxDetune': 'Расстройка (дубль голоса)',
    'ttsFxDetuneDesc': 'Слой чуть расстроенного дубля — «два голоса / синтетический» тембр.',
    'ttsFxMetallic': 'Металлик',
    'ttsFxReverb': 'Реверб',
    'ttsFxBright': 'Яркость (срез верхов)',
    'ttsFxBrightDesc': 'Ниже — глуше, «из рации»; выше — чище и звонче.',
    'mdlAdd': 'Добавить',
    ...
    'pttKeysLabel': 'Клавиши удержания',
    'pttKeysDesc': 'Нажмите «Назначить» и зажмите нужное сочетание — до трёх клавиш',
    'pttUnset': 'Не назначено',
    'pttPressKeys': 'Зажмите клавиши…',
    'pttAssign': 'Назначить',
    'pttNoWake': 'Слово-активатор в этом режиме не нужен: сказанное при удержании сразу считается командой, «Режим распознавания» на это не влияет.',
    'pttPassthrough': 'EVS не перехватывает клавишу — она продолжает работать в других программах. Если это мешает, добавьте к ней модификатор.',
    'pttConflict': 'Это же сочетание открывает окно EVS. Выберите другое, иначе каждая попытка заговорить будет разворачивать окно.',
    ...
    'cloneSrvTitle': 'Локальный сервер клона',
    'cloneSrvDesc': 'Запускает sidecar/qwen_tts_server.py на этом компьютере. Нужен python с torch и CUDA — обычный интерпретатор не подойдёт.',
    'cloneSrvStart': 'Запустить сервер',
    'cloneSrvStop': 'Остановить',
    'cloneSrvStarting': 'Запускаю…',
    'cloneSrvRunning': 'Сервер работает',
    'cloneSrvStopped': 'Сервер не запущен',
    'cloneSrvNoPython': 'Не найден python с torch. Укажите путь к интерпретатору ниже.',
    'cloneSrvNoScript': 'Не удалось развернуть скрипт сервера.',
    'cloneSrvExited': 'Сервер завершился',
    'cloneSrvFailed': 'Не удалось запустить сервер — подробности в журнале.',
    'cloneSrvPython': 'Путь к python (если не нашёлся сам)',
    'ttsCosyCheck': 'Проверить соединение',
    'ttsCosyOnline': 'На связи',
    'ttsCosyOffline': 'Не отвечает',
    'ttsCosyFellBack': 'Клон-сервер не отвечает — заготовленные фразы играют из кэша, новые озвучит обычный голос',
    ...
    'updSplashKicker': 'УСТАНОВКА ОБНОВЛЕНИЯ',
    'bootPhaseStart': 'ЗАПУСК EVS',
    'bootPhaseSettings': 'ЗАГРУЗКА НАСТРОЕК',
    'bootPhaseTray': 'ТРЕЙ И ГОРЯЧИЕ КЛАВИШИ',
    'bootPhaseComponent': 'ЗАГРУЗКА КОМПОНЕНТОВ',
    'bootPhaseSidecar': 'ЗАПУСК СЛУЖБЫ РАСПОЗНАВАНИЯ',
    'bootPhaseConnect': 'ПОДКЛЮЧЕНИЕ К СЛУЖБЕ',
    'bootPhaseModels': 'ЗАГРУЗКА МОДЕЛЕЙ РАСПОЗНАВАНИЯ',
    'bootPhaseWarming': 'ПРОГРЕВ ДВИЖКА',
    'bootPhaseReady': 'ГОТОВА СЛУШАТЬ',
    'bootPhaseError': 'СЛУЖБА РАСПОЗНАВАНИЯ НЕ ЗАПУСТИЛАСЬ',
    'bootNoteUpdCheck': 'Проверка обновлений',
    'bootNoteUpdDownload': 'Скачивание обновления',
    'bootNoteUpdReady': 'Обновление готово к установке',
    'webSearch': 'Веб-поиск',
    ...
    'webSearchKeysHint': 'Работает без ключа (DuckDuckGo). Ключ любого другого поисковика — стабильнее и качественнее.',
    'webSearchTavily': 'Tavily API-ключ (необязательно)',
    'webSearchBrave': 'Brave API-ключ (необязательно)',
    'webSearchGoogleKey': 'Google API-ключ',
    'webSearchGoogleCx': 'Google: ID поискового движка (cx)',
    'webSearchYandexKey': 'Яндекс API-ключ',
    'webSearchYandexFolder': 'Яндекс: идентификатор каталога (folderid)',
    'webSearchProvider': 'Поисковик',
    'webSearchProviderDesc': 'Авто — пробует те, у кого задан ключ, и DuckDuckGo как запасной. Выбранный вручную используется строго один.',
    'webSearchAuto': 'Авто',
    'webSearchGoogleHint': 'Нужны два значения: ключ из Google Cloud и ID движка, созданного в Programmable Search Engine.',
    'webSearchYandexHint': 'Нужны ключ и folderid из Yandex Cloud (сервис Search API).',
    ...
    'uiStyleDesc': 'Компоновка и оформление окон. Тема ниже задаёт только цвета.',
    'uiStyleClassic': 'Классический',
    'uiStyleNexus': 'Nexus',
    'uiStyleClassicDesc': 'Боковая панель с историей и один экран чата',
    'uiStyleNexusDesc': 'Рейл, орб со спутниками, карточки подсистем, чат колонкой',
    'uiStyleNoctur': 'Ноктюрн',
    'uiStyleNocturDesc': 'Вкладки, сцена во всё окно, строка телеметрии',
    'ncTabCommands': 'Команды',
    'ncStateKicker': 'СОСТОЯНИЕ',
    'ncHintIdle': 'Скажите слово-активатор или спросите текстом',
    'ncHintListening': 'Слушаю — говорите',
    'ncHintThinking': 'Думаю над ответом',
    'ncHintSpeaking': 'Отвечаю голосом',
    'ncAskPlaceholder': 'Спросите текстом — или просто скажите «{w}»',
    'ncAskPlaceholderPtt': 'Спросите текстом — или зажмите {w} и говорите',
    'ncAskPlaceholderPlain': 'Спросите текстом',
    'ncReply': 'ответ ≈ {n} с',
    'ncGb': 'ГБ',
    'ncHome': 'Главный экран',
    'ncSearchChats': 'Поиск по диалогам',
    'ncGrpPinned': 'Закреплено',
    'ncGrpToday': 'Сегодня',
    'ncGrpYesterday': 'Вчера',
    'ncGrpEarlier': 'Ранее',
    'ncNoChat': 'Выберите диалог или начните новый',
    'ncReplies': '{n} реплик',
    'ncSec': 'с',
    'ncComposerHint': 'Написать сообщение',
    'ncSearch': 'Поиск',
    'ncEdit': 'Изменить',
    'ncAll': 'Все',
    'ncCmdNeedsConfirm': 'подтверждение',
    'ncColPhrase': 'Фраза-триггер',
    'ncColAction': 'Действие',
    'ncColType': 'Тип',
    'ncColReply': 'Отклик',
    'ncNoCommands': 'Команд пока нет',
    'ncCopy': 'Скопировать',
    'ncCopied': 'Скопировано',
    'ncLogFolder': 'Папка логов',
    'ncRefresh': 'Обновить',
    'ncLogVoice': 'Голос',
    'ncLogModel': 'Модель',
    'ncLogRemote': 'Телефон',
    'ncLogUpdates': 'Обновления',
    'ncLogErrors': 'Ошибки',
    'ncLogEmpty': 'Записей нет',
    'ncBack': 'Назад',
    'ncLlmShort': 'нейросеть',
    'ncWhatsNewKicker': 'ОБНОВЛЕНИЕ',
    'ncWhatsNew': 'Что нового',
    'ncFullChangelog': 'Полный список изменений',
    'nxNavDialog': 'Диалог',
    'nxNavCommands': 'Голосовые команды',
    'nxNavModels': 'Модели',
    'nxNavLog': 'Журнал',
    'nxStatus': 'Статус',
    'nxIdle': 'Ожидание',
    ...
    'nxWave': 'Волны',
    'nxBars': 'Спектр',
    'nxChatHint': 'Напишите сообщение…',
    'nxToday': 'сегодня',
    'nxSpeaking': 'Говорю',
    'nxSystem': 'Система',
    'nxTtsClone': 'Клон (XTTS)',
    'nxTtsSystem': 'Система',
    'nxOnline': 'онлайн',
    'nxOffline': 'оффлайн',
  ...
  'en': {
    ...
    'navVoiceInput': 'Microphone & recognition',
    'navVoiceInputSub': 'what the assistant hears',
    'navVoiceCommands': 'Voice commands',
    'navVoiceCommandsSub': 'computer control',
    'navModel': 'Neural network',
    ...
    'navLog': 'Log',
    'navLogSub': 'what the app has been doing',
    'navAbout': 'About',
    ...
    'startupView': 'Show after startup',
    'startupViewDesc': 'The main window and the floating widget are picked together. The assistant announces that it is ready to listen either way — even with nothing on screen.',
    'startupViewWidget': 'Widget only',
    'startupViewBoth': 'Window and widget',
    'startupViewWindow': 'Window only',
    'startupViewNone': 'Nothing',
    ...
    'sttEngineDesc': 'The EVS engine (Whisper/GigaAM locally, or recognition on a server)',
    'localEngineName': 'Local (EVS)',
    'msShort': 'ms',
    'cardSttModel': 'Recognition engine',
    'engWhisperName': 'Whisper',
    ...
    'engRemoteName': 'On a server',
    'engRemoteShort': 'Recognized by someone else\'s GPU. Needs your own server',
    'engRemoteDetail':
        'The phrase is sent to the address below (OpenAI contract: POST /v1/audio/transcriptions). The microphone, noise suppression and phrase segmentation stay here — a finished phrase travels, not a stream. Any ready-made OpenAI-compatible server works: speaches, whisper.cpp server, vLLM. If the server does not answer, the local Whisper picks the phrase up and says so.',
    'engRemoteUrl': 'Server address',
    'engRemoteModel': 'Model',
    'engRemoteKey': 'Access key (if required)',
    'engRemoteCheck': 'Check',
    'engRemoteOnline': 'The server answers',
    'engRemoteOffline': 'The server does not answer',
    'engRemoteNoUrl': 'Enter the server address first',
    ...
    'nxCloseHint': 'close —',
    'clonePhr2Title': 'Prepared phrases',
    'clonePhr2Hint': 'These are pre-rendered in your cloned voice and play instantly with no GPU load (even with the clone server stopped). Total: {n}.',
    ...
    'chatTurnedOff': 'Chat disabled',
    'sysChatOn': 'Enable chat',
    'sysChatOff': 'Disable chat',
    'navAssistantVoice': 'Assistant voice',
    'navAssistantVoiceSub': 'speech, effects, clone',
    // Second navigation level: pages inside a settings section.
    'pgBasics': 'Basics',
    'pgStartup': 'Startup & tray',
    'pgMicDevice': 'Device',
    'pgStt': 'Recognition',
    'pgListen': 'Listening',
    'pgVoiceOut': 'Speech',
    'pgVoiceEngine': 'Synthesis engine',
    'pgVoiceClone': 'Clone & GPU load',
    'pgVoiceFx': 'Voice effects',
    'pgVoicePhrases': 'Prepared phrases',
    'pgWsLook': 'Look',
    'pgWsParams': 'Parameters',
    'pgCmdExec': 'Execution',
    'pgCmdCatalog': 'Command catalog',
    'pgCmdSecurity': 'Security',
    'pgLlmConn': 'Connection',
    'pgLlmModels': 'Models',
    'pgLlmParams': 'Generation parameters',
    'pgPersonaStyle': 'Conversation style',
    'pgPersonaMemory': 'Memory',
    'pgPrivAccess': 'Access & limits',
    'pgPrivData': 'Data',
    'pgAboutInfo': 'Version & updates',
    'pgChangelog': 'Changelog',
    'settingsSearchHint': 'Search settings…',
    'voiceStatusMic': 'Microphone',
    'voiceStatusStt': 'Recognition',
    'voiceStatusVoice': 'Voice',
    'voiceStatusReady': 'listening',
    'voiceStatusPtt': 'on key hold',
    'pttHintHold': 'Hold and speak',
    'pttHintUnset': 'Assign the hold keys in settings',
    ...
    'micGainDesc':
        'How much louder to make the mic signal. Helps when you are hard to '
            'hear or sitting far away: quiet speech otherwise never clears the '
            'loudness gate, however sensitive the speech detector is. It lifts '
            'noise too — raise it only as far as needed. 1.0x = unchanged.',
    'micSensLow': 'Low',
    'micSensMed': 'Medium',
    'micSensHigh': 'High',
    'micSensMax': 'Max',
    'ttsFx': 'Voice effect (FX)',
    'ttsFxDesc': 'Post-processing of synthesized/cloned speech: detune double, metallic, reverb, high-cut — e.g. an EDI-style synthetic AI voice.',
    'ttsFxPreset': 'Preset',
    'ttsFxPresetDesc': 'Apply a ready-made setting (EDI).',
    'ttsFxDetune': 'Detune (voice double)',
    'ttsFxDetuneDesc': 'A slightly detuned double — the two-voice / synthetic timbre.',
    'ttsFxMetallic': 'Metallic',
    'ttsFxReverb': 'Reverb',
    'ttsFxBright': 'Brightness (high-cut)',
    'ttsFxBrightDesc': 'Lower = muffled/radio; higher = clearer.',
    'mdlAdd': 'Add',
    ...
    'pttKeysLabel': 'Hold keys',
    'pttKeysDesc': 'Press "Assign" and hold the combination you want — up to three keys',
    'pttUnset': 'Not set',
    'pttPressKeys': 'Hold the keys…',
    'pttAssign': 'Assign',
    'pttNoWake': 'No wake word here: whatever you say while holding the keys is treated as a command, and "Recognition mode" has no effect on it.',
    'pttPassthrough': 'EVS does not intercept the key — it keeps working in other apps. Add a modifier if that gets in the way.',
    'pttConflict': 'This is also the shortcut that opens the EVS window. Pick another one, or every attempt to speak will pop the window up.',
    ...
    'cloneSrvTitle': 'Local clone server',
    'cloneSrvDesc': 'Runs sidecar/qwen_tts_server.py on this machine. Needs a python with torch and CUDA — a plain interpreter will not do.',
    'cloneSrvStart': 'Start server',
    'cloneSrvStop': 'Stop',
    'cloneSrvStarting': 'Starting…',
    'cloneSrvRunning': 'Server is running',
    'cloneSrvStopped': 'Server is not running',
    'cloneSrvNoPython': 'No python with torch found. Set the interpreter path below.',
    'cloneSrvNoScript': 'Could not unpack the server script.',
    'cloneSrvExited': 'Server exited',
    'cloneSrvFailed': 'Could not start the server — see the log for details.',
    'cloneSrvPython': 'Path to python (if not found automatically)',
    'ttsCosyCheck': 'Check connection',
    'ttsCosyOnline': 'Online',
    'ttsCosyOffline': 'Not responding',
    'ttsCosyFellBack': 'Clone server offline — cached phrases still play, new text uses the fallback voice',
    ...
    'updSplashKicker': 'INSTALLING UPDATE',
    'bootPhaseStart': 'STARTING EVS',
    'bootPhaseSettings': 'LOADING SETTINGS',
    'bootPhaseTray': 'TRAY AND HOTKEYS',
    'bootPhaseComponent': 'DOWNLOADING COMPONENTS',
    'bootPhaseSidecar': 'STARTING THE RECOGNITION SERVICE',
    'bootPhaseConnect': 'CONNECTING TO THE SERVICE',
    'bootPhaseModels': 'LOADING RECOGNITION MODELS',
    'bootPhaseWarming': 'WARMING THE ENGINE UP',
    'bootPhaseReady': 'READY TO LISTEN',
    'bootPhaseError': 'THE RECOGNITION SERVICE FAILED TO START',
    'bootNoteUpdCheck': 'Checking for updates',
    'bootNoteUpdDownload': 'Downloading an update',
    'bootNoteUpdReady': 'Update ready to install',
    ...
    'webSearchGoogleKey': 'Google API key',
    'webSearchGoogleCx': 'Google: search engine ID (cx)',
    'webSearchYandexKey': 'Yandex API key',
    'webSearchYandexFolder': 'Yandex: folder id',
    'webSearchProvider': 'Search engine',
    'webSearchProviderDesc': 'Auto tries the ones with a key, then DuckDuckGo as a fallback. A manually picked engine is the only one used.',
    'webSearchAuto': 'Auto',
    'webSearchGoogleHint': 'Two values are needed: a Google Cloud key and the ID of an engine created in Programmable Search Engine.',
    'webSearchYandexHint': 'Needs a key and a folder id from Yandex Cloud (Search API).',
    ...
    'uiStyleDesc': 'Window layout and styling. The theme below sets colours only.',
    'uiStyleClassic': 'Classic',
    'uiStyleNexus': 'Nexus',
    'uiStyleClassicDesc': 'Sidebar with history and a single chat screen',
    'uiStyleNexusDesc': 'Rail, orb with satellites, subsystem cards, chat column',
    'uiStyleNoctur': 'Noctur',
    'uiStyleNocturDesc': 'Tabs, a full-window stage, one telemetry line',
    'ncTabCommands': 'Commands',
    'ncStateKicker': 'STATE',
    'ncHintIdle': 'Say the activation word or ask in text',
    'ncHintListening': 'Listening — go ahead',
    'ncHintThinking': 'Working on the answer',
    'ncHintSpeaking': 'Answering out loud',
    'ncAskPlaceholder': 'Ask in text — or just say “{w}”',
    'ncAskPlaceholderPtt': 'Ask in text — or hold {w} and speak',
    'ncAskPlaceholderPlain': 'Ask in text',
    'ncReply': 'reply ≈ {n} s',
    'ncGb': 'GB',
    'ncHome': 'Home screen',
    'ncSearchChats': 'Search chats',
    'ncGrpPinned': 'Pinned',
    'ncGrpToday': 'Today',
    'ncGrpYesterday': 'Yesterday',
    'ncGrpEarlier': 'Earlier',
    'ncNoChat': 'Pick a chat or start a new one',
    'ncReplies': '{n} messages',
    'ncSec': 's',
    'ncComposerHint': 'Write a message',
    'ncSearch': 'Search',
    'ncEdit': 'Edit',
    'ncAll': 'All',
    'ncCmdNeedsConfirm': 'confirmation',
    'ncColPhrase': 'Trigger phrase',
    'ncColAction': 'Action',
    'ncColType': 'Type',
    'ncColReply': 'Reply',
    'ncNoCommands': 'No commands yet',
    'ncCopy': 'Copy',
    'ncCopied': 'Copied',
    'ncLogFolder': 'Log folder',
    'ncRefresh': 'Refresh',
    'ncLogVoice': 'Voice',
    'ncLogModel': 'Model',
    'ncLogRemote': 'Phone',
    'ncLogUpdates': 'Updates',
    'ncLogErrors': 'Errors',
    'ncLogEmpty': 'Nothing logged',
    'ncBack': 'Back',
    'ncLlmShort': 'model',
    'ncWhatsNewKicker': 'UPDATE',
    'ncWhatsNew': "What's new",
    'ncFullChangelog': 'Full changelog',
    'nxNavDialog': 'Dialog',
    'nxNavCommands': 'Voice commands',
    'nxNavModels': 'Models',
    'nxNavLog': 'Log',
    'nxStatus': 'Status',
    'nxIdle': 'Idle',
    ...
    'nxWave': 'Waves',
    'nxBars': 'Spectrum',
    'nxChatHint': 'Type a message…',
    'nxToday': 'today',
    'nxSpeaking': 'Speaking',
    'nxSystem': 'System',
    'nxTtsClone': 'Clone (XTTS)',
    'nxTtsSystem': 'System',
    'nxOnline': 'online',
    'nxOffline': 'offline',
