...
const Map<String, Map<String, String>> _i18n = {
  'ru': {
    ...
    'ncActiveModel': 'Активная модель',
    'ncServerAddress': 'Адрес сервера',
    'ncCheck': 'Проверить',
    'ncTokens': 'токенов',
    'ncRemote': 'удалённая',
    'ncInstalled': 'установлена',
    'ncActive': 'Выбрана',
    'ncUse': 'Выбрать',
    'ncOnDisk': 'На диске:',
    'ncBack': 'Назад',
  ...
  'en': {
    ...
    'ncActiveModel': 'Active model',
    'ncServerAddress': 'Server address',
    'ncCheck': 'Check',
    'ncTokens': 'tokens',
    'ncRemote': 'remote',
    'ncInstalled': 'installed',
    'ncActive': 'Selected',
    'ncUse': 'Select',
    'ncOnDisk': 'On disk:',
    'ncBack': 'Back',
